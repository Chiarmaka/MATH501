###############################################################
#
## MATH500 Coursework part 2
## Module leader: Luciana Dalla Valle
## Develop by: MSc Data Science and Business Analytic 2018/2019
## Team contains: 10603288_10502673_10630583_10473010
#  
#
##############################################################

## The following are the library that has been used to develop this coursework.
## These libraries need to be loaded before start to work.
library(readr)
library(tidyr)
library(dplyr)
library(ggplot2)
...
setwd("C:\\Users\\osdelgadogomes\\Downloads\\MATH500-PART2\\MATH500-PART2")
#
